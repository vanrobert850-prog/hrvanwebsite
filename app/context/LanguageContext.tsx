...
const translations = {
    en: {
        ...
        'trust.secure.desc': 'All transactions protected by Shopify. Your data is always safe.',
    ...
    es: {
        ...
        'trust.secure.desc': 'Todas las transacciones protegidas por Shopify. Tus datos siempre seguros.',
